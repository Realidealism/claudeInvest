      ...
      <details className="text-xs text-text-secondary mt-6">
        ...
        <ul className="mt-2 space-y-1 list-disc pl-4">
          ...
          <li>攻防進出場（防守＝高點＋向下趨勢；攻擊＝底部＋向上趨勢）：
            ...
            <span className="text-text-primary">④ 恐慌急殺早轉攻</span>——防守中若「深跌＋融資急殺＋快殺 10 日跌 ≤ −10%」（真急殺 V），立即轉攻接反彈：2020 COVID 早 6 天、2025 關稅早 3 天、20 日後 +9~11%；用比顯示的恐慌買進（−6%）更嚴的 −10%，慢熊跌得慢到不了、不會自動接刀（−6% 版實測會，2022 涵蓋 60%→48%）。
