...
FUNDS = [
    ...
    ("00980A", "野村臺灣智慧優選",       None,     "etf", "野村", "nomura",      '{"fund_no": "00980A"}'),
    ("00993A", "安聯台灣主動式",         None,     "etf", "安聯", "allianz",     '{"fund_id": "E0001"}'),
    ("00982A", "群益台灣精選強棒",       None,     "etf", "群益", "capitalfund", '{"fund_id": "399"}'),
    ("00992A", "群益台灣科技創新主動",   None,     "etf", "群益", "capitalfund", '{"fund_id": "500"}'),
]
